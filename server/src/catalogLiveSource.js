  ...
  try {
    ...
    const sources = await Promise.all([
      fetchJson("https://dummyjson.com/products?limit=0")
        ...
        .catch((err) => {
          console.warn("[catalog-live] dummyjson failed:", err.message);
      ...
      fetchJson("https://fakestoreapi.com/products")
        ...
        .catch((err) => {
          console.warn("[catalog-live] fakestore failed:", err.message);
      ...
      fetchJson("https://api.escuelajs.co/api/v1/products")
        ...
        .catch((err) => {
          console.warn("[catalog-live] escuelajs failed:", err.message);
