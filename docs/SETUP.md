...
Expected: **83/83** Jest tests, **20/20** search checks, **13/13** ML checks, optional local LLM smoke returns no hard failures, live paid-provider LLM passes with valid keys.  
